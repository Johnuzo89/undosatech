...
drop policy if exists "studies visible to owner or institution" on public.studies;
create policy "studies visible to owner or institution"
...
-- No direct client INSERT/UPDATE/DELETE — writes go through the backend.
...
drop policy if exists "logs follow study visibility" on public.study_logs;
create policy "logs follow study visibility"
...
drop policy if exists "rounds follow study visibility" on public.study_rounds;
create policy "rounds follow study visibility"
...
alter table public.fl_node_heartbeats enable row level security;

drop policy if exists "heartbeats scoped to institution" on public.fl_node_heartbeats;
create policy "heartbeats scoped to institution"
...
drop policy if exists "invitations visible to parties" on public.study_invitations;
...
drop policy if exists "own access request readable" on public.access_requests;
create policy "own access request readable"
...
drop policy if exists "published cohorts readable" on public.cohorts;
create policy "published cohorts readable"
